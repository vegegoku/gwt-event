...
public class MouseWheelEvent extends MouseEvent<MouseWheelHandler> {
  ...
  private static final Type<MouseWheelHandler> TYPE = new Type<MouseWheelHandler>(
      BrowserEvents.MOUSEWHEEL, new org.gwtproject.event.dom.client.MouseWheelEvent());
  ...
  static {
     ...
     * calls 'mousewheel'.
     */
    new Type<MouseWheelHandler>("DOMMouseScroll", new org.gwtproject.event.dom.client.MouseWheelEvent());
  }
