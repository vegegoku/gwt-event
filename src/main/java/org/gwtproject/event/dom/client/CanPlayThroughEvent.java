...
public class CanPlayThroughEvent extends DomEvent<CanPlayThroughHandler> {
  ...
  private static final Type<CanPlayThroughHandler> TYPE = new Type<
      CanPlayThroughHandler>(BrowserEvents.CANPLAYTHROUGH, new org.gwtproject.event.dom.client.CanPlayThroughEvent());
   ...
   * org.gwtproject.event.shared.HasHandlers)} to fire media can play through
   * events.
   */
