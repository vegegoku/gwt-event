...
/**
 * {@link org.gwtproject.event.dom.client.DomEvent} is a subclass of {@link GwtEvent} that provides events that
...
public abstract class DomEvent<H extends EventHandler> extends GwtEvent<H>
  ...
  public static class Type<H extends EventHandler> extends GwtEvent.Type<H> {
    private org.gwtproject.event.dom.client.DomEvent<H> flyweight;
    private String name;

    /**
     * This constructor allows dom event types to be triggered by the
     * {@link org.gwtproject.event.dom.client.DomEvent#fireNativeEvent(com.google.gwt.dom.client.NativeEvent, HasHandlers)}
     ...
     *          native event
     */
    public Type(String eventName, org.gwtproject.event.dom.client.DomEvent<H> flyweight) {
  ...
  private static org.gwtproject.event.dom.client.PrivateMap<List<Type<?>>> registered;
  ...
  public static void fireNativeEvent(NativeEvent nativeEvent,
    ...
    if (registered != null) {
      ...
      if (types != null) {
        for (org.gwtproject.event.dom.client.DomEvent.Type<?> type : types) {
  ...
  static void init() {
    registered = new org.gwtproject.event.dom.client.PrivateMap<List<Type<?>>>();
  }
  ...
  @Override
  public abstract org.gwtproject.event.dom.client.DomEvent.Type<H> getAssociatedType();
