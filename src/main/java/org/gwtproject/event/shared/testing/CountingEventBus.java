 ...
 */
public class CountingEventBus extends org.gwtproject.event.shared.EventBus {
  ...
  public CountingEventBus(org.gwtproject.event.shared.EventBus wrapped) {
    real = new com.google.web.bindery.event.shared.testing.CountingEventBus(wrapped);
  }

  public <H extends EventHandler> org.gwtproject.event.shared.HandlerRegistration addHandler(
  ...
  public <H extends EventHandler> org.gwtproject.event.shared.HandlerRegistration addHandlerToSource(
