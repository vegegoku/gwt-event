...
public abstract class GwtEvent<H extends EventHandler> extends Event<H> {
  ...
  @Override
  public abstract org.gwtproject.event.shared.GwtEvent.Type<H> getAssociatedType();
   ...
   * event can be revived by calling {@link org.gwtproject.event.shared.GwtEvent#revive()}.
   */
