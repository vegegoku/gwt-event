...
public class ValueChangeEvent<T> extends GwtEvent<ValueChangeHandler<T>> {
  ...
  public static <T> void fire(HasValueChangeHandlers<T> source, T value) {
    if (TYPE != null) {
      org.gwtproject.event.logical.shared.ValueChangeEvent<T> event = new org.gwtproject.event.logical.shared.ValueChangeEvent<T>(value);
  ...
  public static <T> void fireIfNotEqual(HasValueChangeHandlers<T> source,
    ...
    if (shouldFire(source, oldValue, newValue)) {
      org.gwtproject.event.logical.shared.ValueChangeEvent<T> event = new org.gwtproject.event.logical.shared.ValueChangeEvent<T>(newValue);
      source.fireEvent(event);
    }
  }
