...
public class ResizeEvent extends GwtEvent<ResizeHandler> {
  ...
  public static <S extends HasResizeHandlers & HasHandlers> void fire(S source,
    ...
    if (TYPE != null) {
      org.gwtproject.event.logical.shared.ResizeEvent event = new org.gwtproject.event.logical.shared.ResizeEvent(width, height);
  ...
  /**
   * Construct a new {@link org.gwtproject.event.logical.shared.ResizeEvent}.
   * 
   * @param width the new width
   * @param height the new height
   */
