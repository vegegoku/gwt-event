...
public abstract class HandlerTestBase extends GWTTestCase {
  ...
  public String getModuleName() {
    return "org.gwtproject.event.Event";
  }
  ...
  private HashSet<org.gwtproject.event.shared.EventHandler> active = new HashSet<org.gwtproject.event.shared.EventHandler>();
  ...
  void add(org.gwtproject.event.shared.EventHandler handler) {
    active.add(handler);
  }

  void assertFired(org.gwtproject.event.shared.EventHandler... handler) {
