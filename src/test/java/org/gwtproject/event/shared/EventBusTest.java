...
public class EventBusTest extends TestCase {
  org.gwtproject.event.shared.EventBus bus = new EventBus() {

    @Override
    public <H extends org.gwtproject.event.shared.EventHandler> org.gwtproject.event.shared.HandlerRegistration addHandler(Type<H> type, H handler) {
    ...
    @Override
    public void fireEvent(org.gwtproject.event.shared.GwtEvent<?> event) {
      throw new UnsupportedOperationException();
    }
