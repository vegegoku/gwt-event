...
public class HandlerManagerTest extends HandlerTestBase {
  ...
  public void testAddAndRemoveHandlers() {
    org.gwtproject.event.shared.HandlerManager manager = new org.gwtproject.event.shared.HandlerManager("bogus source");
  ...
  public void testConcurrentAdd() {
    final org.gwtproject.event.shared.HandlerManager manager = new org.gwtproject.event.shared.HandlerManager("bogus source");
  ...
  class ShyHandler implements MouseDownHandler {
    org.gwtproject.event.shared.HandlerRegistration r;
  ...
  public void testMultiFiring() {
    ...
    org.gwtproject.event.shared.HandlerManager manager = new org.gwtproject.event.shared.HandlerManager("source1");

    final org.gwtproject.event.shared.HandlerManager manager2 = new org.gwtproject.event.shared.HandlerManager("source2");
  ...
  public void testReverseOrder() {
    ...
    final org.gwtproject.event.shared.HandlerManager manager = new org.gwtproject.event.shared.HandlerManager("source1", true);
  ...
  public void testHandlersThrow() {
    ...
    final org.gwtproject.event.shared.HandlerManager manager = new HandlerManager("bogus source");
  ...
  public void testNullSourceOkay() {
    org.gwtproject.event.shared.SimpleEventBus reg = new SimpleEventBus();
